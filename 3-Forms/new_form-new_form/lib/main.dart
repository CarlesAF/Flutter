            ...
            Expanded(
                  ...
                  children: [
                    OutlinedButton(
                      style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(color: Color.fromARGB(255, 255, 237, 209)),
                      ),
                      onPressed: () {
                      showDialog(
                      context: context,
              ...
              OutlinedButton(
                style: OutlinedButton.styleFrom(
                    ...
                    foregroundColor: Colors.black87,
                    side: const BorderSide(color: Color.fromARGB(255, 171, 207, 196)),
                ),
                onPressed: () {
                showDialog(
                  context: context,
              ...
              style: OutlinedButton.styleFrom(
                ...
                foregroundColor: Colors.black87,
                side: const BorderSide(color: Color.fromARGB(255, 209, 225, 255)),
                ),
                onPressed: (){
              ...
              OutlinedButton(
                style: OutlinedButton.styleFrom(
                  ...
                  foregroundColor: Colors.black87,
                  side: const BorderSide(color: Color.fromARGB(255, 239, 201, 247)),),
                onPressed: () {
